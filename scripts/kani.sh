...
run_harness proof_recompute_matches_per_market_sum_n8
run_harness proof_recompute_aggregate_drift_recovery_idempotence
...
run_harness proof_classify_upsert_position_slot_totality_and_kind
