...
| `recompute_aggregate` byte-equals `Σ Market::worst_case_lp_loss` (N=8, narrowed-domain) | `crates/sour-verifier/src/kani_harnesses.rs::proof_recompute_matches_per_market_sum_n8` | Kani |
| `recompute_aggregate` is independent of the prior counter value (drift-recovery idempotence, N=4) | `crates/sour-verifier/src/kani_harnesses.rs::proof_recompute_aggregate_drift_recovery_idempotence` | Kani |
